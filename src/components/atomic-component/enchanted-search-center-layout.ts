...
* Search template.
*/
@customElement('enchanted-search-center-layout')
export class EnchantedSearchCenterLayout extends EnchantedAcBaseElement {
  ...
  render() {
    return html`
      <div part="header-container">
        <div part="header"><slot name="enchanted-header"></slot></div>
      </div>
      <div part="pagination-container">
        <div part="pagination"><slot name="enchanted-pagination"></slot></div>
      </div>
      <div part="main">
...
declare global {
  interface HTMLElementTagNameMap {
    'enchanted-search-center-layout': EnchantedSearchCenterLayout
  }
}
