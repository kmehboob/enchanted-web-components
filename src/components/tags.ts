...
export const ENCHANTED_TOGGLE_BUTTON_GROUP_TAG_NAME = `${COMPONENT_PREFIX}enchanted-toggle-button-group`;
...
export const ENCHANTED_TOGGLE_BUTTON_GROUP_TAG = unsafeStatic(ENCHANTED_TOGGLE_BUTTON_GROUP_TAG_NAME);
